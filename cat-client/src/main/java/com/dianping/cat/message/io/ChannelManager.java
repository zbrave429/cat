...
public class ChannelManager implements Task {
        ...
        try {
            ...
            for (int i = 0; i < len; i++) {
                ...
                if (holder != null) {
                    ...
                    m_logger.info("success when init CAT server, new active holder" + holder);
                    return holder;
                }
            }
        } catch (Exception e) {
    ...
    public static class ChannelHolder {
        ...
        public String toString() {
            return "active future :" + m_activeFuture.channel().remoteAddress() +
                    " index:" + m_activeIndex +
                    " ip:" + m_ip +
                    " server config:" + m_activeServerConfig;
        }
    }
