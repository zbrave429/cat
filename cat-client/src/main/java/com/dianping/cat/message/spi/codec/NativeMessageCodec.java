...
public class NativeMessageCodec implements MessageCodec {
    ...
    public static final byte ID = MessageCodecTypeEnum.NT1.getValue(); // native message tree version 1
    ...
    enum Codec {
        ...
        HEADER {
            ...
            protected Message decode(Context ctx, ByteBuf buf) {
                ...
                byte version = ctx.getVersion(buf);
    ...
    private static class Context {
         ...
         * @return
         */
        public byte getVersion(ByteBuf buf) {
            return buf.readByte();
        }
        ...
        public void writeVersion(ByteBuf buf, byte codecType) {
            buf.writeByte(codecType);
        }
    }
